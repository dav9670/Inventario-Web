                ...
                success: function( response ){
                    ...
                    $.each(response.products, function(idx, elem){
                        ...
                        if(elem.licence_count == 0){
                            deleteLink = '<?= $this->Html->link(__('Delete'), ['action' => 'delete', -3], ['class' => 'delete-link', 'confirm' => __('Are you sure you want to delete {0}?', -1)]) ?>';
                        } else {
                            deleteLink = '<?= $this->Html->link(__('Delete'), ['action' => 'delete', -3], ['class' => 'delete-link', 'confirm' => __('Are you sure you want to delete {0}? {1} items are associated with it.', -1, -2)]) ?>';
